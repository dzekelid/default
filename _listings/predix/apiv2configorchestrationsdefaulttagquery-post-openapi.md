...
x-complete: 0
info:
  title: Predix Analytics Runtime Create the default tag query corresponding for the
    tenant.
  version: 1.0.0
  description: Creates the default tag query including all information (query string,
